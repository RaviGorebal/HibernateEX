   ...
   <tr> 
    ...
    <tr> 
      ...
      <td height="24" colspan="2">&nbsp;</td> 
		<logic:present name="EmployeeForm" property="employeeId">
			<bean:define id="employeeId" name="EmployeeForm" property="employeeId"></bean:define>
			<logic:greaterThan name="employeeId" value="0">
				<td><html:button property="method"  onclick="editEmployee()">Update Employee</html:button></td>
			</logic:greaterThan>	
			<logic:equal name="employeeId" value="0">
				<td><html:button property="method"  onclick="addEmployee()">Add Employee</html:button></td>
			</logic:equal>  
		</logic:present>      
		<td height="24" colspan="2">&nbsp;</td> 
    </tr> 
