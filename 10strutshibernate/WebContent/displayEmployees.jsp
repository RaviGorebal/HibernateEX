...
<logic:present name="EmployeeListForm" property="arlEmployee">
	...
	<tr>
		...
		<td class="tdfont"><html:button property="method"  onclick="editEmployee(3)">Update</html:button></td>
		<td class="tdfont"><html:button property="method"  onclick="deleteEmployee(3)">Delete</html:button></td>	
	</tr>			
	</logic:iterate>
</logic:present>		             
</table>
